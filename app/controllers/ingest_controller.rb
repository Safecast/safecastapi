class IngestController < ApplicationController
  def index
    ...
    @device_ids = {
      'central_japan' => ['safecast:974587752', 'safecast:479911182', 'safecast:4007513236', 'safecast:374304606',
                          'safecast:271575163', 'safecast:1162749983'],
      ...
      'southern_california' => ['safecast:872300871', 'safecast:4267748403', 'safecast:4249659165', 'safecast:4177786812',
                                ...
                                'safecast:2299238163', 'safecast:2152053642', 'safecast:114699387', 'safecast:1094924990',
                                'safecast:1045649384']
    }[@area]
    @data = []
